...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    # this method is to access settings
    @classmethod
    def from_crawler(cls, crawler):
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoint = settings.get('SCRAPEOPS_FAKE_USER_AGENT_ENDPOINT', "https://headers.scrapeops.io/v1/user-agents?api_key=11c44a57-2ece-4b64-b8f9-a3ac2351804d")
